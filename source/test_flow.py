...
from source.model import FastGravNet, NeutrinoGravNetWithRegression, NeutrinoGravNetWithFlowRegression
...
def run_flow_testing(cfg: DictConfig):
    ...
    backbone = NeutrinoGravNetWithFlowRegression(cfg_this_run.model).to(device)
